<script lang="ts">
	...
	const seo = $derived(generateSEOTags({
		...
		url: buildLangPath('/tags', data.lang),
		type: 'website',
		lang: data.lang
	}));
</script>
...
<svelte:head>
	...
	<link rel="alternate" hreflang="en-US" href="https://vibeblog.app/en/tags" />
</svelte:head>
	...
	{:else}
		<div class="tags-list">
			{#each data.tags as tag}
				<a href={buildLangPath(`/tags/${encodeURIComponent(tag)}`, data.lang)} class="tag-link">
					{tag}
				</a>
			{/each}
		</div>
